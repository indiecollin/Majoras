...
const useHover = (props, setInfoBar, setToEquip) => {
...
const AddHoverEffect = (props) => {   
// const AddHoverEffect = React.forwardRef((props, ref) => {
  const {Component, parentWidth, setInfoBar, setToEquip} = props;
  ...
  return (props) => {
      const [hovered, eventHandlers] = useHover(props, setInfoBar, setToEquip);
    //   const getRef = (ref) => {
    //     console.log(ref);
    //   }
       return <HoverContainer positionRules = {mirrorStyles} flexRules={ flexStyles }>
          <Component {...props} {...eventHandlers} ref={ref}/>
